      ...
      <div ref={containerRef} style={{ display: 'grid', gridTemplateColumns: `${sidebarWidth}px auto 1fr`, minBlockSize: '38rem' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', overflow: 'auto' }}>
          ...
          {(() => {
            ...
            const isGroupOverridden = isActiveFlipped || (activeGroup?.records.some(r => { const detail = overrides[`sup-pg${r.engagementPageId}`]; return detail?.userOverrideDecision?.includes('Not Superseded') || (detail && detail.userOverrideDecision !== `Page ${r.engagementPageId} = ${r.decisionType}`) }) ?? false)
