...
export const supersededA: SupersededRecord[] = [
  {
    ...
    decisionReason: 'A newer, corrected version of this document exists (page 32). The older version (page 21) can be removed. Both documents belong to the same person and company. The newer document has updated values that should be used instead.',
  ...
  },
  {
    ...
    decisionReason: 'This is the most recent version of the document (page 32). It is marked as "Corrected" and has updated information. The older version (page 21) should be removed.',
    reviewRequired: false,
    escalationReason: null,
