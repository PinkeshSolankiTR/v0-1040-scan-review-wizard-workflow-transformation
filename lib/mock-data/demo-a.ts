...
export const supersededA: SupersededRecord[] = [
  {
    ...
    comparedValues: [
      { field: 'Payer Name', valueA: 'EXXON MOBIL CORPORATION', valueB: 'EXXON MOBIL CORPORATION', match: true, cropA: { x: 0.05, y: 0.12, width: 0.42, height: 0.04 }, cropB: { x: 0.05, y: 0.12, width: 0.42, height: 0.04 } },
      { field: 'Payer (Transfer Agent)', valueA: 'COMPUTERSHARE', valueB: 'COMPUTERSHARE', match: true, cropA: { x: 0.05, y: 0.17, width: 0.42, height: 0.04 }, cropB: { x: 0.05, y: 0.17, width: 0.42, height: 0.04 } },
      { field: 'Recipient Name', valueA: 'JILL ANDERSON', valueB: 'JILL ANDERSON', match: true, cropA: { x: 0.05, y: 0.24, width: 0.42, height: 0.04 }, cropB: { x: 0.05, y: 0.24, width: 0.42, height: 0.04 } },
      { field: 'Recipient SSN', valueA: '***-**-1234', valueB: '***-**-1234', match: true, cropA: { x: 0.05, y: 0.29, width: 0.25, height: 0.04 }, cropB: { x: 0.05, y: 0.29, width: 0.25, height: 0.04 } },
      { field: 'Total Ordinary Dividends (Box 1a)', valueA: '$3,285.60', valueB: '$3,412.80', match: false, cropA: { x: 0.52, y: 0.32, width: 0.44, height: 0.05 }, cropB: { x: 0.52, y: 0.32, width: 0.44, height: 0.05 } },
      { field: 'Qualified Dividends (Box 1b)', valueA: '$2,890.40', valueB: '$3,012.50', match: false, cropA: { x: 0.52, y: 0.38, width: 0.44, height: 0.05 }, cropB: { x: 0.52, y: 0.38, width: 0.44, height: 0.05 } },
      { field: 'Document Number', valueA: 'D04018', valueB: 'D04018-C', match: false, cropA: { x: 0.72, y: 0.06, width: 0.24, height: 0.04 }, cropB: { x: 0.72, y: 0.06, width: 0.24, height: 0.04 } },
      { field: 'Corrected', valueA: 'No', valueB: 'Yes', match: false, cropA: { x: 0.30, y: 0.04, width: 0.14, height: 0.04 }, cropB: { x: 0.30, y: 0.04, width: 0.14, height: 0.04 } },
    ],
  },
  {
    engagementPageId: 32,
