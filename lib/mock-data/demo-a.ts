...
export const supersededA: SupersededRecord[] = [
  {
    ...
    decisionReason: 'W-2 from WHYNOT STOP INC (page 1) is superseded by a corrected W-2 (page 2). Employee SSN, employer EIN, and tax year all match. Corrected version has updated wage amounts.',
  ...
  },
  {
    ...
    appliedRuleSet: 'SourceDocs',
    decisionRule: 'SUPERSEDED_BY_AMENDED',
    decisionReason: 'K-1 (Form 1041) for JILL BAKER FAMILY TRUST may have been superseded by an amended K-1. The "Amended K-1" checkbox is marked on page 5. Trust EIN matches but beneficiary ID differs slightly. Manual review recommended.',
    reviewRequired: true,
    escalationReason: null,
